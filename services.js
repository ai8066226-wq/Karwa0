...
function renderPreview() {
  ...
  const theme = window.KarwaServiceThemes?.resolve?.({ category, serviceType:currentApplication?.serviceType || "", description:byId("pDescription")?.value || currentProfile?.description || "", items:providerItems }) || { image:"./theme-parcel.webp?v=65", accent:"#087b75", icon:"🧰", key:"parcel" };
