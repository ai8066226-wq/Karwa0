# Karwa Phase 76 / 2.2.7

## جديد Phase 76 — وضع قيادة اتجاهي وتتبع حي محسّن

- مؤشرات سهم/سيارة/دراجة موجهة للأعلى عند 0° (الشمال) وتدور مع `heading` الحقيقي.
- تحديث موقع الكابتن أثناء الطلب كل نحو ثانيتين، مع تحريك سلس للمؤشر لدى العميل.
- إعادة حساب مسار الملاحة للكابتن كل نحو 5 ثوانٍ أو بعد حركة تقارب 30 مترًا.
- إعداد شكل المؤشر محفوظ للكابتن وينتقل إلى العميل مع بيانات التتبع.

راجع `README-PHASE76-AR.md`.

## جديد Phase 74 — حماية المحفظة حسب العملية

- لا يمكن تنفيذ أي عملية عليها رسم إذا كان الرصيد المتاح (المشحون + الرصيد المجاني غير المنتهي) أقل من الرسم المطلوب.
- رسوم مستقلة من لوحة الإدارة:
  - العميل: طلب تكسي.
  - العميل: توصيل غرض.
  - العميل: مطاعم/خدمات.
  - الكابتن: قبول رحلة تكسي.
  - الكابتن: قبول توصيل.
  - المطعم: قبول طلب.
  - الخدمات الأخرى: قبول طلب.
  - رسم نشر النشاط.
- الخصم يتم مع العملية نفسها، وقواعد Firestore تتحقق من الرسم المحدد من الإدارة ومن انخفاض الرصيد بالقيمة الصحيحة.
- لا يتم تنفيذ الطلب أو القبول أو النشر عند نقص الرصيد، ويظهر للمستخدم مقدار الرسم المطلوب مع توجيهه لشحن المحفظة.
- تمت المحافظة على حقول الرسوم القديمة كـ fallback للتوافق مع الإعدادات الحالية.
