const CACHE='karwa-phase34-services-approval-v1';
const CORE=['./','./index.html','./driver.html','./admin.html','./services.html','./portal.css','./app.js?v=34','./driver.js?v=33','./admin.js?v=34','./services.js?v=4','./pwa.js?v=34','./manifest.webmanifest','./karwa-icon.svg'];
