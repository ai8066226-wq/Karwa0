const CACHE='karwa-phase52-landmark-names-v2';
const CORE=['./','./index.html','./driver.html','./admin.html','./services.html','./portal.css?v=35','./app.js?v=53','./driver.js?v=53','./admin.js?v=52','./services.js?v=52','./pwa.js?v=53','./manifest.webmanifest','./karwa-icon.svg'];
