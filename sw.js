const CACHE='karwa-phase55-professional-auth-v1';
const CORE=['./','./index.html','./driver.html','./admin.html','./services.html','./portal.css?v=53','./app.js?v=55','./driver.js?v=53','./admin.js?v=53','./services.js?v=52','./pwa.js?v=55','./manifest.webmanifest','./karwa-icon.svg'];
