const CACHE='karwa-phase58-driver-notifications-v1';
const CORE=['./','./index.html','./driver.html','./admin.html','./services.html','./portal.css?v=53','./app.js?v=55','./driver.js?v=58','./admin.js?v=53','./services.js?v=57','./pwa.js?v=58','./manifest.webmanifest','./karwa-icon.svg'];
