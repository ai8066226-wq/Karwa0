const CACHE='karwa-phase37-no-service-images-v1';
const CORE=['./','./index.html','./driver.html','./admin.html','./services.html','./portal.css?v=35','./app.js?v=37','./driver.js?v=36','./admin.js?v=36','./services.js?v=7','./pwa.js?v=37','./manifest.webmanifest','./karwa-icon.svg'];
