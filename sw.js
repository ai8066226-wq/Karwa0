const CACHE='karwa-phase25-resilient-sync-v1';
const CORE=['./','./index.html','./driver.html','./admin.html','./portal.css','./app.js?v=25','./driver.js','./admin.js','./pwa.js?v=25','./manifest.webmanifest','./karwa-icon.svg'];
