const CACHE='karwa-phase48-provider-pickup-otp-v1';
const CORE=['./','./index.html','./driver.html','./admin.html','./services.html','./portal.css?v=35','./app.js?v=48','./driver.js?v=48','./admin.js?v=44','./services.js?v=48','./pwa.js?v=48','./manifest.webmanifest','./karwa-icon.svg'];
