const CACHE='karwa-phase51-fixed-wallet-v1';
const CORE=['./','./index.html','./driver.html','./admin.html','./services.html','./portal.css?v=35','./app.js?v=51','./driver.js?v=51','./admin.js?v=51','./services.js?v=51','./pwa.js?v=51','./manifest.webmanifest','./karwa-icon.svg'];
