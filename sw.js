const CACHE='karwa-private-admin-phase56-v1';
const CORE=['./','./index.html','./admin.html','./portal.css?v=56','./admin.js?v=56','./pwa.js?v=56','./manifest.webmanifest','./karwa-icon.svg'];
