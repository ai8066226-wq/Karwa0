const CACHE='karwa-phase63-persistent-session-v1';
const CORE=['./','./index.html','./driver.html','./admin.html','./services.html','./portal.css?v=63','./app.js?v=63','./driver.js?v=63','./admin.js?v=63','./services.js?v=63','./pwa.js?v=63','./precise-location.js?v=63','./manifest.webmanifest','./karwa-icon.svg'];
