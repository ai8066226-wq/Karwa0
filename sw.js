const CACHE='karwa-phase30-customer-cockpit-v1';
const CORE=['./','./index.html','./driver.html','./admin.html','./portal.css','./app.js?v=30','./driver.js?v=29','./admin.js','./pwa.js?v=30','./manifest.webmanifest','./karwa-icon.svg'];
