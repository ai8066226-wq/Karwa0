const CACHE='karwa-phase47-service-approval-delivery-dispatch-v1';
const CORE=['./','./index.html','./driver.html','./admin.html','./services.html','./portal.css?v=35','./app.js?v=44','./driver.js?v=44','./admin.js?v=44','./services.js?v=7','./pwa.js?v=44','./manifest.webmanifest','./karwa-icon.svg'];
