const CACHE='karwa-phase29-driver-cockpit-v1';
const CORE=['./','./index.html','./driver.html','./admin.html','./portal.css','./app.js?v=25','./driver.js?v=29','./admin.js','./pwa.js?v=29','./manifest.webmanifest','./karwa-icon.svg'];
