const CACHE='karwa-phase31-customer-map-controls-v1';
const CORE=['./','./index.html','./driver.html','./admin.html','./portal.css','./app.js?v=30','./driver.js?v=29','./admin.js','./pwa.js?v=31','./manifest.webmanifest','./karwa-icon.svg'];
